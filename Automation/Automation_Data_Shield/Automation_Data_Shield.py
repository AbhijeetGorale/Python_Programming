...
# To Run This Script You Have To Give Two Parameters While Executing The Program 

# To Execute - python File_name.py Time_interval Directory_name 

# Time_interval =  After how much time you want to get backup Pass that while Executing
# Directory name = which directory you want to get backed up Pass that directory Name while Executing 
#  This Program will work on the Existing Directory 